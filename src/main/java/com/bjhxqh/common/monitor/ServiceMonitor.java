package com.bjhxqh.common.monitor;

import com.bjhxqh.common.exception.ServerInternalErrorException;
...
public class ServiceMonitor {
     ...
     * under that.
     */
    @Pointcut("execution(* com.bjhxqh.service..*(..))")
     ...
     */
    @AfterThrowing(pointcut = "com.bjhxqh.common.monitor.ServiceMonitor.serviceLayer()", throwing = "e")
